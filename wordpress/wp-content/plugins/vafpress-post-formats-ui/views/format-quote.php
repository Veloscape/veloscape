<div id="vp-pfui-format-quote-fields" style="display: none;">
	...
	<div class="vp-pfui-elm-block">
		<label for="vp-pfui-format-quote"><?php _e('Quote', 'vp-post-formats-ui'); ?></label>
		<textarea name="_format_quote" id="vp-pfui-format-quote" tabindex="1"><?php echo esc_attr(get_post_meta($post->ID, '_format_quote', true)); ?></textarea>
	</div>
	<div class="vp-pfui-elm-block">
