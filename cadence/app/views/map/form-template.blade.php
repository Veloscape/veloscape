<div id="blank" class="map-form-entity">
    ...
    <div class="form-section">
        <div class="section-title">
            <span class="h4">1. Which option matches this location best?</span>
        </div>
    ...
    <div class="form-section">
        <div class="section-title">
            <span class="h4">2. How would you rate this section of your route?</span>
        </div>
        <div class="section">
    ...
    <div class="section-comment">
        <div class="section-reverse">
            <span class="h4">3. Any additional thoughts or comments?</span>
        </div>
